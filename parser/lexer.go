...
func NewLexer(file int, str string, log *errlog.ErrorLog) *Lexer {
	...
	t.addTokenDefinition("/->", TokenArrowRightOut)
	t.addTokenDefinition("/<-", TokenArrowRightIn)
	t.addTokenDefinition("<-/", TokenArrowLeftOut)
	t.addTokenDefinition("->/", TokenArrowLeftIn)
